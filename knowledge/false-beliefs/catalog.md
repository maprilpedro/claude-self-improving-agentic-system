...
## FB-027: "Inbound requests from adjacent orgs for your data or methodology are extraction/theft risks"

- **Source**: Live observation — Rubin outreach from Silvia Mulet Ferre + Angela Han (AEP), April 15-16, 2026. Pedro's initial reaction was fear of data theft. The thread outcome revealed a collaborative ask.
- **Date**: 2026-04-16
- **Common belief**: When an adjacent team asks for access to your data, dashboards, or methodology, they're likely going to rebuild a parallel version and claim credit. Protect the artifact. Share as little as possible. Gatekeep access.
- **Why it's wrong**: On shared infrastructure (same data warehouse, same upstream platform), there's nothing in the data layer to protect — they already have access at the source. What distinguishes your product is the **definition and interpretation layer**, not the raw data. Inbound requests signal that you've built something with reference value. The "dogs that don't bark" in a collaborative ask are decisive: absence of territorial language, absence of time pressure, absence of slow-walking, confirmation of your entity list, active invitation to test their tool — these are the signals of partnership, not extraction. When you're wired to scan for theft, you miss the invitation embedded in the ask, and you respond with gatekeeping language that damages the relationship while ceding the definition layer to the asker anyway.
- **The Rubin case specifically**: Pedro feared AEP would rebuild Felix's dashboard on their side. What actually happened: (1) Rubin already ingests all the same events, (2) the 7 AEM-owned agent identifiers Pedro shared were confirmed on Rubin's side in one message, (3) Angela invited Pedro to test the Digest tab and give feedback, (4) Karthik flagged a provisioning API gap that Felix's local Prod org list could help close, inverting the power dynamic. The feared outcome was architecturally impossible. The real risk was the opposite — being absent from the canonical definition in the CXO tool where VPs look.
...
## FB-030: "My implication will read at exec speed"

- **Source**: Pedro NYL TBYB email thread, 2026-05-07. Pedro replied to a customer-escalation question with data only (git URL + Grafana URL + "data is 3 weeks old, I'm not aware of other way"). Implicit ownership ("Raul is maintaining" → Raul has it covered) was intended but not stated. Corey responded next message with *"This is a broken process alert"* and added Yanira + Tina; Bertrand assigned: *"@Pedro @Yanira can you please take the lead here?"*
- **Date**: 2026-05-07
- **Common belief**: A senior reader will infer the ownership / fix path / commitment that you implied between the lines. If they don't ask a clarifying question, the implication landed.
- **Why it's wrong**: Senior leaders read at speed, on phone, between meetings. They react to **literal words on the page**, not to inferred meaning. *"From what I know, X is maintaining"* + *"I'm not aware of other way"* literally reads as *"I don't know."* The reader does not pause to reconstruct your intended ownership signal. Implication requires inference work the writer didn't do — and senior leaders don't do that inference work because their attention is rationed across many threads. The cost shows up as: (a) the reader assigns the work explicitly because they didn't see it owned, (b) peers in the thread read the implication-only reply as evidence of broken process, (c) recovery requires a forward-framed clarification, not a backward-framed defense (see "Don't Litigate Prior Replies").
- **What to do instead**: On any thread that includes (a) a customer name, (b) a VP-level person, and (c) a process / ownership question — the first reply must include **one literal ownership sentence** even if the rest is technical content. Examples: *"Raul owns this; I'll close the loop with him by [time]."* / *"NYL: I'll get the answer to the account team by EOD."* / *"Routing to [PgM] for process; I'll cover the data side."* Pair with the technical content. Don't omit. Scan first sentence before sending: does it have an active verb attributable to a named person? If not, rewrite.
- **Caveat**: This rule applies to customer-escalation + VP-visibility threads. Internal-team Slack DMs and casual fyi forwards don't need the explicit ownership sentence — the audience there does the inference work because the relationship and context are richer. The mistake is applying internal-team writing style to exec-visible threads.

## FB-031: "Good work gets recognized and moves you up — the workplace is a meritocracy"

- **Source**: Jiang Xueqin, *"If You Start With Nothing, This Is the Only Wealth Game That Works"* (ingested 2026-06-02, routed as a career mental model at Pedro's request) **+ Pedro's own lived evidence: 10 years as Director doing strong work without the promotion, and his self-named gap (visibility / self-promotion).** Pedro's words: *"je crois toujours que je dois travailler sur les choses que je maîtrise, que mon bon travail sera bien reconnu. Et je comprends que c'est faux."*
- **Date**: 2026-06-02
- **Common belief**: If I master my domain and do excellent work, recognition and advancement will follow. Merit is the engine of promotion. Working on what I'm best at is the safe path up.
- **Why it's wrong**: The video's transferable diagnosis (stripped of its wealth-specific content) — **winners do not compete on the visible "merit" axis; they play a structural game.** The rich don't out-earn, they control what becomes money and who can create it (position, not effort). Merit is the *mythology* that keeps honest players grinding inside a game they can't win on those terms — "des gens qui travaillent dur toute leur vie sans jamais construire de richesse… ils se blâment." The corporate translation: **Director → Senior Director is not "more / better work." It is structural position** — the scope only you own, the definitions you control, the rooms you're in, your proximity to the deciders. Doing more excellent execution inside your mastered lane *reinforces* your current level; it does not change your structural position. Pedro stuck 10 years while doing good work is the lived proof. This belief is load-bearing for the system's existing diagnoses: it's the *root* under H-003 (visibility gap), H-005 (owning the measurement substrate = structural cross-org influence — the one resolved hypothesis), FB-030 (implication doesn't read at exec speed), and McIntyre's *position power vs personal power*.
- **What to do instead**: Stop optimizing mastery + output *for recognition*. Optimize **position**, per the five rules in `leadership/` → "The Game Itself — Position Over Merit": (1) don't compete, create a lane only you hold; (2) control what counts as value (the metric, the narrative, the definition); (3) write the framework others operate inside, don't just operate well inside theirs; (4) proximity to the deciders beats silent excellence; (5) structural position compounds, effort resets each cycle. Recognition is a *byproduct* of position, never a substitute for it.
- **Caveat (the analogy's hard limit — do not import the fatalism)**: The video is **fatalistic about wealth** — "the game is rigged and you are not invited," closed to anyone without political/dynastic connections. That doom does **not** transfer to the career game. The Director → Senior Director game rewards the *same structural moves* (position over merit) but it is **learnable and open** to a Director who chooses to play it. Pedro can play this game; the dynastic-wealth player largely cannot. Keep the *diagnosis* (position > merit, merit-belief is the trap), discard the *conspiracy / closed-door conclusion*. The value here is the cognitive unlock — stop blaming the quality of your work, change which game you're playing — not a victim narrative.

## FB-032: "Being agreeable and well-liked is the safe path up"

- **Source**: Robert Greene, *"How to Make People Fear Disrespecting You"* (FR transcript, ingested 2026-06-02) **+ Pedro's self-named gap** (validation-seeking + over-accommodating, H-003).
- **Date**: 2026-06-02
- **Common belief**: Stay liked, avoid friction, accommodate, never make anyone uncomfortable — that's the safe posture, and safety is how you keep moving up.
- **Why it's wrong**: Affection is unstable — it shifts with mood and a single disagreement. Respect that carries a *credible consequence* is far more stable, because people know there's a line. Pure likeability with no line signals you can be rolled, and invites being overridden at the next negotiation (Greene: *not* using your leverage tells the other side they can squeeze you). A Director who never holds a hard line reads at exec speed as *having no leverage* — the opposite of Senior-Director presence. **The honest limit:** the inverse extreme (ruling by fear) is also wrong — it kills the truth-telling a PM depends on. The answer is calibrated: a *touch* of fear / a known boundary, not a reign of it. Translate to corporate as boundaries and consequences, never intimidation.
- **What to do instead**: See `leadership/` → "A Touch of Fear and the Use of Leverage — Respect Is a Position Lever." Be easy to work with **and** hold a known line; use the leverage you actually hold instead of trading it away to stay liked; let an occasional, well-chosen firm "no" stand. Ties to FB-031 (merit myth), H-003 (visibility/self-promotion gap), and the Philippe dynamic (don't retract a position under public pressure).
