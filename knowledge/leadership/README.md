# Leadership — Operating at Senior Director Level

> Patterns, behaviors, and insights on how Senior Directors operate differently from Directors. Not about doing more — about operating at a different scope.

## The Core Distinction

Directors own their product area. Senior Directors shape decisions across areas they don't directly own. The difference is not capability. It is the scope of what you claim as yours to solve.

---

## The Game Itself — Position Over Merit

> **⭐ Foundational frame. Come back to this one.** Pedro's standing instruction (2026-06-02): keep returning to these rules when framing his work, because his default belief — "good work gets recognized and moves me up" — is false (see `false-beliefs/` FB-031). This section is the unifying frame under most of the rest of this file. Source: Jiang Xueqin wealth-game video, translated from "how dynastic wealth is really built" into "how you actually rise to Senior Director." Keep the diagnosis, drop the video's fatalism (the wealth game is closed; the career game is learnable and open — Pedro can play it).

**The flip.** You've been playing the *merit game*: master your domain, do excellent work, wait for recognition. The people who rise play the *position game*: they own structure, leverage, and the rules. Merit is the story that keeps strong executors grinding at their current level. Doing more good work inside your mastered lane reinforces where you are; it does not change your structural position.

**The five rules** (each maps a wealth-game move onto the career game):

1. **Don't compete — create a monopoly.** *(Video: the rich eliminate competition, they don't compete in it.)* Don't try to be the best in a crowded lane. Be the **only** name on a lane you define and name. → Already lived: AEM–AO liaison (Bertrand-named), the consistency layer, the architecture session you now convene. H-005 (resolved) is the proof this works.
2. **Control what counts as value.** *(Video: the rich decide what becomes money and who can make it.)* Whoever defines the metric, the narrative, the criteria controls the game. You run the reporting — so **own the definition of "value" for AEM agents**, don't just measure it. ("Definition Ownership as a Moat" entry below.)
3. **Write the rules, don't follow them.** *(Video: capture legal privilege, write the laws.)* Be in the room where definitions and decisions get written; become the **author of the framework** others operate inside (surface map, skill-declaration standard). Rule-writer outranks rule-follower at the same skill level.
4. **Proximity to the deciders beats silent excellence.** *(Video: regulatory capture, the revolving door.)* Relationships with the people who decide (Bertrand, Loni, Ian, the VPs) move you more than flawless work nobody senior watches. This is your self-named gap, stated structurally. ("Broadcast Frequency Is the Muscle," "MOC-First Ship.")
5. **Position compounds; effort resets.** *(Video: wealth auto-perpetuates.)* A structural position (being THE name on a domain) generates visibility and opportunity on its own, every cycle. Pure effort has to be re-spent each review period and is forgotten. Invest in position, not in another round of output.

**The one-line test for any week's work:** *Is this building my position (a lane only I hold / a definition I own / a room I'm in / a relationship with a decider), or is it just more excellent output inside my current box?* If it's the latter, it may be necessary, but it is not moving you up — name it as such and don't mistake it for progress toward Senior Director.

**Where this already lives in the system** (this frame is the root, not a new island): FB-031 (the merit false belief), H-003 (visibility), H-005 (owning the substrate = structural influence — resolved), McIntyre *position power vs personal power*, Playing to Win *where-to-play / how-to-win*, "Definition Ownership as a Moat," "Co-Author With the Owner," "Broadcast Frequency Is the Muscle," "Use the Forum to Manufacture the Deliverable."
...
- **Source**: Live observation — Bertrand/Pedro report-to-JIRA exchange, April 2, 2026
- **Date**: 2026-04-02
- **Insight**: When an executive asks a technical follow-up question on your work, the optimal response has three parts: (1) answer the specific question concisely and directly, (2) connect it to the already-agreed approach to show coherence — making their question look like it was anticipated, (3) signal forward momentum or scalability to show you're thinking beyond the current scope. This keeps you credible without over-explaining, and turns a clarifying question into a confirmation that you've thought further than they asked.
- **Anti-pattern**: Over-explaining the answer, defending the original decision, or treating the question as a challenge. Executives ask follow-up questions to learn, not to attack. Treat it as curiosity, not scrutiny.
- **PM Application**: Before any exec response to a technical question, ask: what's the one-sentence answer, how does it connect to what we already agreed, and what's the next horizon? Three sentences maximum. Bertrand's "pretty close from what I had in mind" after a short, direct response is the confirmation pattern to aim for.
...
- **Source**: Loni's AEM PM Virtual Working Session IV (Surfaces). Loni named the "hero surfaces / Times Square" concept and left the definition open as an action item. Pedro took it.
- **Pattern**: In leadership sessions, the most valuable moves are often the ones nobody claimed. When a VP names a concept and doesn't assign it, that is an invitation. The person who walks out and writes the first draft owns the framing. Framing is authority.
- **How to recognize it**: Look for concepts named in a session with no clear owner. Open action items with strategic weight. Ideas the facilitator floated but didn't assign.
...
### Read the Org Chart Before You Need It
- **Date identified**: 2026-04-16
- **Source**: Pedro spent ~30 minutes browsing the Adobe org chart (21 screenshots captured). The exercise revealed multiple structural facts that materially changed his strategic reads: Silvia Mulet Ferre manages Eugene Bannykh (she's Adobe Design, not AEP); Jean-Michel Pittet is VP of AEM Engineering (peer VP to Loni, not "role TBD"); Felix Delval is Senior Engineering Manager (not IC); Angela Han is in Shivakumar's Engineering chain, not AEP PM; Haresh Kumar is Sr Director Product Marketing (not Field/Sales PM).
- **Pattern**: Director-level work happens inside a single org. Senior Director work happens across orgs. You cannot operate across orgs without a map of who reports to whom, where VP peers sit, which chains your stakeholders trace up to. Most people read the org chart only when a specific need forces them to (a new meeting, a new ask). Senior Directors read the org chart proactively, before they need it — because it reveals structural facts that change how they frame every subsequent interaction.
- **What the exercise revealed that directly changed Pedro's strategic reads**:
  1. **Cross-org relationships he misread.** Silvia was listed as "UX Manager reporting to Loni" — wrong. She's Adobe Design, and she manages Eugene. That reframed the entire Rubin thread from "AEP power play" to "cross-product design collaboration."
  2. **Upcoming high-stakes meeting revalued.** Jean-Michel was "role TBD" in notes. Actually he's VP Engineering AEM. The Loni + Jean-Michel meeting is the top AEM leadership pair, not a generic Loni update. Preparation effort should match.
  3. **Peer weight recalibrated.** Felix (Sr Eng Manager, reports to VP Michael Marth two hops up), Conrad (Sr Principal Architect, direct to Jean-Michel), Ian Boston (Principal Scientist direct to VP Alexander Saar) all carry more structural weight than generic titles suggest. Bringing them to cross-org meetings changes the optics.
  4. **Collaborative tone decoded.** Angela Han was friendly not because Pedro charmed her, but because she's in Engineering and not competing on product scope. Understanding the *why* behind a tone stops you from misreading it.
- **How to apply**: Schedule ~30 minutes once per quarter (or when entering a new scope) to walk the org chart. Capture chains for: your direct chain, your peer VPs' chains, the VP chains of adjacent orgs you touch, and the chains of anyone who has contacted you in the last month. Save as stakeholder map entries or a dedicated reporting-chains artifact. The insight compounds — each interaction you have afterward gets contextualized by structure.
- **Senior Director signal**: The willingness to invest time in structural intel, not just task execution, is a Senior Director operating habit. Directors execute within the structure. Senior Directors understand the structure so they can operate across it.
- **Related**: McIntyre Power Grid Mapping; Senior Director "scope of influence" frame.

---

## Strategic Narrative

### Lead with "So What," Not "What Happened"
- **Date identified**: 2026-03-26
- **Source**: Director PM framework, reinforced across Loni's sessions.
- **Pattern**: Directors report what happened. Senior Directors explain why it matters and what comes next. The same facts can be presented at two very different levels:
  - Director: "EPA had a 9% success rate in W12, down from 43% all-time."
  - Senior Director: "EPA's 9% external success rate is not a quality problem — it's an architecture ceiling. AO 2.0 addresses the root cause. Until it lands (May-July), no prompt improvements will move this number materially. The right investment is measurement standardization, not agent tuning."
- **Application**: Before any written or verbal update, ask: "What does this mean and what should we do about it?" Lead with that. Put the data second.

### Connect Every Artifact to the Company Direction
- **Date identified**: 2026-03-26
- **Source**: Loni's use of Project 42 as the organizing frame across multiple sessions.
...
### Be in the Room Where Concepts Are Named
- **Date identified**: 2026-03-26
- **Source**: Pedro's inclusion in Loni's Session I and Session IV. Both small, senior, first-principles sessions.
- **Pattern**: Senior Directors are sought out for strategy sessions. Getting into those rooms is not automatic — it requires that you've already demonstrated you can operate at that level. Being in the room is a lagging indicator; contributing visibly while in the room is a leading indicator of being invited back.
- **What "contributing visibly" looks like**: Proposing a framing that gets repeated by others. Asking the question that reorients the discussion. Not talking the most — saying the one thing that makes the room think differently.
- **Example**: Pedro's persona-based interaction model (Session I, March 23) was validated by Conrad in front of Loni. That's a contribution that gets remembered and attributed.

### Your Point Gets Echoed = Credibility Signal
- **Date identified**: 2026-03-26
...
### Separate the Strategic Position from the Capacity Conversation
- **Date identified**: 2026-03-26
- **Source**: Hero Surfaces one-pager. "Naming Experience Hub as the hero surface is a strategic position. What gets built on that foundation is a separate roadmap conversation."
- **Pattern**: One of the most common ways Director-level work gets blocked is by attaching strategic proposals to resource asks. Leadership can reject the resource ask and the strategy dies with it. Separate them. Get the strategic position validated first. Then have the capacity conversation.
- **Anti-pattern**: "We should be the hero surface, but we'd need two more engineers to do it right." The second sentence kills the first.

### Governance Posture Is a Senior Director Signal
- **Date identified**: 2026-03-27
- **Source**: Shankari 1:1 handoff, March 27.
- **Pattern**: Senior Directors hold a line that Directors often avoid holding because it creates friction. In a shared platform like Experience Hub, every team wants real estate. Saying no — or "show me the homework first" — is not popular. But it is the thing that keeps the product from becoming noise. Shankari's standard: no addition without a JIRA, design involvement, user research, and a hypothesis. No announcement without a conversion metric and a 4-week review date. No engineer going to engineering directly on Slack to "stick a button somewhere."
...
## Operating at Senior Director Level
...
### Do Not Respond to Overwhelm by Adding More
- **Source**: Pedro session, April 24, 2026 (same session)
- **Date**: 2026-04-24
- **Observation**: Initial instinct on "help me out" was to produce another framework or another plan. That would have added to the overwhelm. The actual unlock was to stop producing and start subtracting — name the four things that matter, give permission to drop the rest, and offer to do one load-bearing item end-to-end rather than returning another list.
- **Pattern**: An overwhelmed leader asking for help does not want a new plan. They want the existing plan pruned and one thing removed from their plate. The trap is that "help" feels like "produce" in an AI-assist context, but for overwhelm the right help is often a cut, a parking label, and a specific offer to carry one task through.
...
### MOC-First Ship — Operationalization of Broadcast Frequency

- **Date**: 2026-05-08
- **Source**: Pedro 5-rep streak May 5-8 (Briefing v0 ✅ → AOv2 5-phase plan ✅ → MCP MOC ✅ → NYL recovery → Master-list scoping group DM ✅ → all with leader 1-click ack within hours).
- **Insight**: The "broadcast frequency" muscle becomes operational through a specific artifact-shape pattern: **ship a tangible MOC (mockup, draft, scope outline) before requirements are complete, before data is connected, before the artifact is "polished" — and use the senior leader's 1-click ack as direction validation.** Then gate broader broadcast on internal polish. The pattern compresses what would normally be a 2-3 week alignment cycle into a 24-hour direction-check.
- **The four ingredients that make it work**:
  1. **Tangible artifact (not a description of one).** Slack a deck snapshot, a mockup, a 1-pager, a draft Slack message — never "I'm thinking about building X." The thing itself, even if 30% complete.
  2. **Honest caveat in the cover note.** Examples: *"Still refining on my side, but gives you the direction."* / *"Numbers Claude invented for the report template, not connected, not validated."* / *"Draft for review."* Caveats protect the relationship while the work is rough.
  3. **Direct send to the senior leader, not the team.** Bertrand-direct beats team-broadcast for direction-validation. Team broadcast is for stage 3 (after polish).
  4. **One specific signal sought.** Not approval. Not feedback. **Direction** — *"is this the shape you wanted?"* Leader's 1-click reaction (👍, "go ahead", "looks right") = direction confirmed. Anything more = signal for revision.
- **Why this compresses the cycle**: Without the MOC, leaders have to imagine what you're building from your verbal description, then ask clarifying questions, then wait for a draft, then react. With the MOC, the imagining step is eliminated — they react to the artifact, not the idea. **The artifact does the cognitive work the conversation would have done.**
- **The gating rule for broader broadcast**: After 1-click ack, the artifact still needs to be polished before it goes to the team / agent owners / cross-org. The leader sign-off is direction-grade, not publication-grade. Treat them as separate stages: stage 1 ship to leader (rough OK), stage 2 polish, stage 3 broadcast wide.
- **Confirmed reps** (Pedro, May 5-8 2026):
  1. **Briefing v0** (Apr 30) → Bertrand named at VP level (sponsorship-grade ack)
  2. **AOv2 5-phase plan** (May 5, verbal in 1-1) → Bertrand explicit validation (*"plutôt pour faire une évaluation"*)
  3. **MCP MOC report** (May 6 Slack) → Bertrand acked, direction validated
  4. **Master-list scoping group DM to Yanira + Andre** (May 7) → Yanira aligned in 2 min, condition added
  5. **AOv2 evaluation formalization proposal to Bertrand** (May 7) → Bertrand: *"je t'appelle demain"* (call-grade response, higher than ack)
- **Counter-pattern — what doesn't work**:
  - Pitch a structure verbally without a MOC → leaders ask "where is it?" and you lose the moment.
  - Wait for full polish before showing → cycle stretches to weeks, leader's mind moves on.
  - Send to multiple people simultaneously → no one reads carefully because anyone could.
- **Why this is Senior Director, not Director**: Directors execute against approved specs. Senior Directors ship MOCs that *create* the spec by giving leaders something to react to. The PM who ships the MOC defines the artifact. The PM who waits for the spec executes someone else's artifact.
- **PM application**: Build a "MOC drawer" — at any moment have 2-3 half-finished artifacts ready to send when the right moment arrives. The half-finished state IS the value, not a defect. The artifact that's polished enough to publish is too late to use as direction-check.
...
### The Director→Senior Director Gap Is a Communication/Visibility Gap, Not a Capability Gap

- **Date promoted**: 2026-05-27 (proposed 2026-03-19 as H-003; confirmed and promoted from `hypotheses/`).
- **Source**: H-003 confirmed over 2026-03 → 2026-05. Origins: Gallo *Presentation Secrets* + Mehrabian; Pedro's self-named visibility gap.
- **The rule**: for an execution-strong Director, the *marginal* bar to Senior Director is overwhelmingly visibility / communication / positioning — not capability or output. Leadership perception is driven far more by how ideas are framed, how often they are broadcast, and who is in the room than by what is delivered.
- **Confirming evidence (3+, 0 against)**:
  - Behavioral self-diagnosis (2026-04-02): execution bias + validation-seeking — both positioning problems, not capability.
  - Broadcast-frequency reps (May 1-8): the gap moved on frequency of broadcasting, not better work.
  - Ian NorthStar thread (2026-05): a well-placed *question* (not a deliverable) moved the architect to ship the NorthStar next day and escalate memory ownership to Saar (VP). Influence via communication.
  - Cross-confirmed by resolved [[H-005]]: cross-org influence accrued from owning and *naming* the substrate before any standard shipped.
- **Operating implications**: subtract-don't-add when overwhelmed (calibration is a Senior Director move); [[Broadcast Frequency Is the Muscle, Not Strategic Comms|broadcast frequency is the muscle]] (reps, not frameworks); a well-aimed question or public naming at altitude can beat another artifact; track reactive-ownership reps separately from proactive ones (H-007).
- **Boundary**: capability is necessary — you cannot communicate past bad work. The rule says the *marginal* gap, given strong work, is communication. Don't read it as "output doesn't matter."
- **Cross-link**: [[H-005]] (resolved), [[Use the Forum to Manufacture the Deliverable and Pre-Load Its Consumers]], [[Substitute-Hosting the Cross-Agent Forum Is Altitude, Not Cover]], feedback memory `feedback_dont_overread_vp_quotes`. Companion open hypothesis: H-007 (reactive vs proactive ownership, reassess 2026-06-05).
