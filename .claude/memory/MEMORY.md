...
- [Slack canvas API gotchas](reference_slack_canvas_api.md) — section-replace is destructive/erratic (3 incidents 07-04); safe mode = full-content replace, no H1; mentions write as `![](@ID)` not `<@ID>`.
