...
- 🔴 **THE FORK IS CONTENT VS BLAST RADIUS, and only Pedro can settle it.** The big program has content for EPA / Discovery / Content Optimization to act on; **CxCowork-2 prod-author is isolated and clean but is EDA-shaped and its content volume is unknown** — a near-empty program produces feedback that looks like a skill failure. ⚠️ **Check content before choosing.**
