...
- ⚠️ **`correct:` 08-15 — MOSTLY ANSWERED ALREADY, do not re-raise as "five people waiting".** Pedro answered Ken on the AO 1.0 prompts at 08-14 07:58 and posted his `Progressive activation` doc `F0BPBFCST5F` at 09:19, **which already carries the lot sizes (50 first, then batches of 500, triaged by org interactions)**. Group DM `C0BQ4L7BVL2` → https://adobe.enterprise.slack.com/archives/C0BQ4L7BVL2/p1786660097959949
