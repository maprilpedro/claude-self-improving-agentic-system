...
- **next session** — draft the MCP business-reporting framework **wiki** (MAU / retention / orgs / tool calls / value realization) — Pedro's call 07-03 ("on tackle le wiki après clear"). Promised to Christian+Jabran twice; strengthens the relance.
