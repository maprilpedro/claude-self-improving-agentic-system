...
> ## ▶️ RESUME HERE — left off **2026-08-26 afternoon**. 🔑🔴 **THE COHORT COMPARISON IS DONE AND IT ANSWERS THE ABAC QUESTION: 34 ABAC ORGS EXIST, 5 ARE ON PAUL'S ROLLOUT LIST, AND ALL 5 ARE SCHEDULED 2026-09-01.** 🔴 **15 more ABAC orgs sit in `Cohort_AEM_WF_SKU`, which appears on none of Paul's three tabs.** 🔑 **Paul's Cohort column is an `XLOOKUP` into Pedro's own workbook, so the 13 "discrepancies" are a stale link, not a disagreement.** ✅ **The internal GA announcement went out 08-25 12:42.** ⚖️ **Pedro lifted the no-code hard rule for this one case.** See the 2026-08-25/26 block directly below.
>
