...
> **Supersedes:** the Manas-call 06-01 "AI Assistant fate OPEN" line + the 06-12 AIA-risk entry's "watch for Akin's reply on whether AIA stays supported" — the *whether* is decided (subsumed, capabilities preserved); the live question is now **timing + AEM-surface continuity**, owned by Sundeep/Sunil/Sachin, to be held to "seamless, no disruption."
