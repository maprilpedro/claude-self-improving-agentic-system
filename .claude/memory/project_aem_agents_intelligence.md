...
> ## ▶️ RESUME HERE — left off **2026-08-11 midday**, with the Loni note drafted and out for review. **Bertrand answered from PTO and opened the Loni path himself; the PMM interception was solved by splitting the artifact, not merging it.** ⏳ **The note goes Wed 08-12 morning — check Bertrand actually replied before it claims he reviewed it.**
>
...
>
> **🔎 KNOWLEDGE (P6):** [[Don't Let Program Managers Carry Your Liaison Relationship]] · [[Get Leadership's Name Alongside Yours]] (Bertrand's cc *is* the name alongside) · [[Surface the Risk Before Leadership Has to Ask]] · [[Lead with "So What," Not "What Happened"]] · [[Say the Sentence That Obliges — the Hedge Transfers the Ask]] (the closing window, not an open "chime in") · [[The Game Itself — Position Over Merit]] rule 4. **New feedback memory: [[feedback_critique_check_facts_not_prose]].**
>
