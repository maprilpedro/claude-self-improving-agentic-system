...
>
> ### 🔴 2026-07-17 — MANAS CALL PREP (call held ~08:00; outcome NOT captured — see watches)
> Agenda Pedro posted: skills migration status · **org→manifest visibility** (the artifact Bertrand has asked for 3×) · the **DOMAIN / WHEN-TO-USE / WHEN-NOT-TO-USE audit** and what exists in Coworker today · migration acceleration. He cut the "multiple marketplaces" line (it is by design in Manas's own model, and posing it as a problem would have cost credibility) and left POD/TBYB out of writing (it straddles Bertrand's base-manifest proposal and the bridge lane; ambiguous in text). **⏳ The call outcome is not banked. Ask.**
>
