...
> **⚠️ Verbatims + follow-ups NOT yet collected** — who said what (Bertrand's words?), which of the ~10, what asks came out of the room (teams wanting the check? surface owners on the definition? AOv2/harness challenges? Saar reaction?). Collect before they evaporate ([[feedback_position_over_merit]] — the feedback is currency only if banked + re-usable).
