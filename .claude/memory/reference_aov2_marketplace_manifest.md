...
> - **⚠️ Open discrepancy to resolve before it is quoted again:** Pedro's 07-08 message to Reasor says **5 of 18** flagged pairs are co-installed in this manifest; the 07-09 audit-agent fact-check says the lexical layer flags **8 candidate intra-pairs** inside it. Both may be true under different thresholds/scopes, but the two numbers have not been reconciled. Do not cite either as settled until they are.
