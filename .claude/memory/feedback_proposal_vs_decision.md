...
**🔴 Instance 2026-07-16, and it is the sharpest one because the source disclaimed himself and we ignored it.** On 2026-07-13 Mark Doten was asked whether "Enable Coworker" can be set without the "AI Kill Switch". He answered: ***"Technically, yes, but that is not my decision."*** We banked the first half as the settled answer — **activation ≠ migration** — and built the v4 status doc, the email to Bertrand/Yanira/Jaclyn, the answers to Ankur and Apoorva, and Pedro's public positions on it. **The second half was the load-bearing one and it was dropped.** On 2026-07-15 **Namita Krishnan**, who actually runs the rollout, said the opposite: *"if a customer has V2, **there's no AI assistant anymore. Like it's just co-worker, no AI assistant**."* Both can be true — **Mark described a capability, Namita describes the policy** — and if so, "technically separable" is worth nothing because nobody intends to use it.
- **The new rule this adds:** a **capability** answer is not a **policy** answer, and *"that is not my decision"* is the speaker telling you which one he just gave. **When a source disclaims authority in the same sentence, the disclaimer travels with the quote — into memory, into the doc, into the artifact.** Never strip it.
- **Self-check:** ask *"can it?"* and *"will it?"* as two questions, of two people. Route "can it" to the engineer and "will it" to the owner of the rollout. A yes to the first is not a yes to the second.
